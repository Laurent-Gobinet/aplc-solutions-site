    ...
    <>
      <header className="site-header">
        <div className="container nav">
          ...
          <nav className="desktop-nav"><a href="#approche">Notre approche</a><a href="#projets">Vos projets</a><a href="#realisations">Nos réalisations</a><a href="#parcours">Qui sommes-nous ?</a><a href="#contact" className="nav-cta">Nous contacter</a></nav>
        </div>
      </header>
      <main id="top">
        ...
        <section id="approche" className="approach section-dark"><div className="container">
          ...
          <div className="approach-grid"><article><span className="num">01</span><h3>Anticiper</h3><p>Préparer les décisions qui engagent l'avenir.</p></article><article><span className="num">02</span><h3>Structurer</h3><p>Construire une stratégie, un financement ou une opération créatrice de valeur.</p></article><article><span className="num">03</span><h3>Décider</h3><p>Sécuriser chaque étape grâce à une vision indépendante et expérimentée.</p></article><article><span className="num">04</span><h3>Déployer</h3><p>Transformer les décisions en résultats concrets et durables.</p></article></div>
        </div></section>
        <section id="projets" className="why"><div className="container why-grid">
          <div className="why-copy"><h2>Pourquoi APLC ?</h2><div className="accent" /><div className="why-items"><article><h3>Plus de 30 ans d'expérience industrielle</h3><p>La connaissance du terrain et des enjeux réels.</p></article><article><h3>Une vision de dirigeant</h3><p>Nous avons occupé votre place. Nous comprenons vos enjeux et vos responsabilités.</p></article><article><h3>Une approche sur mesure</h3><p>Chaque entreprise est différente. Chaque projet mérite une réponse adaptée.</p></article><article><h3>De la stratégie au déploiement</h3><p>Nous restons à vos côtés jusqu'à la mise en œuvre et la création de valeur.</p></article><article><h3>Un engagement total</h3><p>Confidentialité, loyauté et implication dans la réussite de vos projets.</p></article></div></div>
        ...
        <section id="realisations" className="projects"><div className="container"><div className="section-title-row"><h2>Nos réalisations</h2><a href="#contact">Voir toutes les réalisations →</a></div><div className="project-grid">{projects.map((p) => <article className="project-card" key={p.title}><img src={p.img} alt={p.title} /><div><h3>{p.title}</h3><p>{p.text}</p><span>{p.tags}</span></div></article>)}</div></div></section>
        ...
        <section id="contact" className="contact-section"><div className="contact-photo"><img src={photo('outdoor business meeting landscape')} alt="Rencontre professionnelle en extérieur" /></div><div className="container contact-grid"><div className="contact-card"><h2>Échangeons.</h2><div className="accent" /><p>Les décisions stratégiques commencent toujours par une rencontre.</p></div><div className="contact-details"><p>☎ <a href="tel:+33630255807">06 30 25 58 07</a></p><p>✉ <a href="mailto:laurent.gobinet@aplc-solutions.fr">laurent.gobinet@aplc-solutions.fr</a></p><p>⌖ Basé à Nantes<br />Interventions en France et à l'international</p><p>in <a href="https://www.linkedin.com/in/laurent-gobinet-21663930" target="_blank" rel="noopener">linkedin.com/in/laurent-gobinet</a></p></div><div className="qr"><img src="/qr-contact-laurent-gobinet.png" alt="QR code contact Laurent Gobinet" /><span>Ajouter à vos contacts</span></div></div></section>
      </main>
